...
(define (collection-first collection)
  (stream-first collection))

(define (collection-rest collection)
  (stream-rest collection))

(define (collection-null? collection)
  (if (stream-empty? collection) #t #f))

(define (collection-map function collection)
  (stream-map function collection))

(define (collection-filter function collection)
  (stream-filter function collection))
